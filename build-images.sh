...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:17.7-alpine3.21 docker.io/dependencytrack/frontend:4.13.6 docker.io/dependencytrack/apiserver:4.14.0 docker.io/aquasec/trivy:0.68.2 docker.io/library/nginx:1.28.0-alpine" \
    "${container}"
# Commit the image
