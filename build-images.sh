...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:17.10-alpine docker.io/dependencytrack/frontend:4.14.3 docker.io/dependencytrack/apiserver:4.14.3 docker.io/aquasec/trivy:0.72.0 docker.io/library/nginx:1.31.3-alpine" \
    "${container}"
# Commit the image
