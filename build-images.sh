...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:17.11-alpine docker.io/dependencytrack/frontend:5.1.1 docker.io/dependencytrack/apiserver:5.1.1 docker.io/aquasec/trivy:0.74.0 docker.io/library/nginx:1.30.4-alpine" \
