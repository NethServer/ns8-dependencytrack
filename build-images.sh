...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:17.10-alpine docker.io/dependencytrack/frontend:5.0.3 docker.io/dependencytrack/apiserver:5.0.3 ghcr.io/dependencytrack/v4-migrator:5.0.3 docker.io/aquasec/trivy:0.72.0 docker.io/library/nginx:1.30.3-alpine" \
    "${container}"
# Commit the image
