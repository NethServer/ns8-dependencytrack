...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:17.7-alpine3.21 docker.io/dependencytrack/frontend:5.0.1 docker.io/dependencytrack/apiserver:5.0.2 docker.io/aquasec/trivy:0.70.0 docker.io/library/nginx:1.30.2-alpine" \
    "${container}"
# Commit the image
