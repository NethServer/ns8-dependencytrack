...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/postgres:17.5-alpine3.21 docker.io/dependencytrack/frontend:4.13.2 docker.io/dependencytrack/apiserver:4.13.2 docker.io/aquasec/trivy:0.63.0 docker.io/library/nginx:1.28.0-alpine" \
    "${container}"
# Commit the image
